...
st.set_page_config(page_title="My Naira Tracker", page_icon="₦")
...
with col1:
    ...
    income_amount = st.number_input("Amount", min_value=1, key="income")
...
with col2:
    ...
    expense_amount = st.number_input("Amount", min_value=1, key="expense")
